...
namespace PWProject.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,City")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,City")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContext.Producers'  is null.");
            }
            var producer = await _context.Producers.FindAsync(id);
            if (producer != null)
            {
